...
// Code for marking an issue as read (if applicable)
                            ...
                            if($query->rowCount() > 0) {
                                foreach($results as $result) { ?>		
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" onClick="popUpWindow('updateissue.php?iid=<?php echo ($result->id); ?>');">View</a> |
                                            <a href="manageissues.php?delid=<?php echo ($result->id); ?>" onclick="return confirm('Are you sure you want to delete this issue?');">Delete</a>
                                        </td>
                                    </tr>
                                <?php } 
                            } ?>
