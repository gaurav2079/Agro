...
<div class="banner-3">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">AGRO Toursim Packages</h1>
	</div>
</div>
<!--- /banner ---->
<!--- selectroom ---->
		...
		<div class="selectroom_top">
			...
			<div class="selectroom-info animated wow fadeInUp animated" data-wow-duration="1200ms" data-wow-delay="500ms" style="visibility: visible; animation-duration: 1200ms; animation-delay: 500ms; animation-name: fadeInUp; margin-top: -70px">
				<ul>
					...
					<button type="submit" name="submit2" href=""class="btn-primary btn">Book</button>
						</li>
