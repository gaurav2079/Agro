...
<html>
<head>
<title>TMS | Product Details</title>
...
<div class="banner-3">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">AGRO Toursim Products</h1>
	</div>
</div>
<!--- /banner ---->
<!--- selectroom ---->
...
<?php 
$pid=intval($_GET['pkgid']);
$sql = "SELECT * from tbltourproducts where ProductId=:pid";
$query = $dbh->prepare($sql);
$query -> bindParam(':pid', $pid, PDO::PARAM_STR);
$query->execute();
